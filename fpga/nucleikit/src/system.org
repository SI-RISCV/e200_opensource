...
(
  ...
  input wire ck_rst,//FPGA_RESET-T6


  // Dedicated QSPI interface
  output wire qspi_cs,//FPGA_IIO1-N14
  output wire qspi_sck,//FPGA_IO4-T16
  inout wire [3:0] qspi_dq,//qspi_dq[1]-FPGA_IO0-P16    DO
                           //qspi_dq[0]-FPGA_IO3-U16    DI
                           //qspi_dq[3]-FPGA_IO2-Y17
                           //qspi_dq[2]-FPGA_IO5-R17
  ...
  inout wire pmu_paden, // ly //PMU_VDDPADEN-U15
  inout wire pmu_padrst,// ly //PMU_VADDPARST_V15
  inout wire mcu_wakeup // ly //MCU_WAKE-N15
);
  ...
  assign pmu_paden  = dut_io_pads_aon_pmu_vddpaden_o_oval;  //LD4
  assign pmu_padrst = dut_io_pads_aon_pmu_padrst_o_oval;		//LD5
