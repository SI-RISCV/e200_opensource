...
(
  ...
  wire dut_io_pads_qspi_sck_i_ival = 1'b0;
  ...
  wire dut_io_pads_qspi_cs_0_i_ival = 1'b0;
  ...
  e200_fpga_soc_top dut
  (
    //.clock(hfclk),
       // Use the low frequency clock, becuase the 65MHz have the timing violations 
    .hfclk(hfclk),
       // Note: this is not the SoC top level reset signal
    .hfclkrst(),
