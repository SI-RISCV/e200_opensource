...
module e203_itcm_icb_gen(

  input  i_icb_cmd_valid,
  output i_icb_cmd_ready,
  input  [`E203_ITCM_ADDR_WIDTH-1:0] i_icb_cmd_addr,
  input  i_icb_cmd_read,
  input  [`E203_ITCM_DATA_WIDTH-1:0] i_icb_cmd_wdata,
  input  [`E203_ITCM_WMSK_WIDTH-1:0] i_icb_cmd_wmask,

  output i_icb_rsp_valid,
  input  i_icb_rsp_ready,
  output i_icb_rsp_err,
  output [`E203_ITCM_DATA_WIDTH-1:0] i_icb_rsp_rdata,

  output o_icb_cmd_valid,
  input  o_icb_cmd_ready,
  output [`E203_ITCM_ADDR_WIDTH-1:0] o_icb_cmd_addr,
  output o_icb_cmd_read,
  output [`E203_ITCM_DATA_WIDTH-1:0] o_icb_cmd_wdata,
  output [`E203_ITCM_WMSK_WIDTH-1:0] o_icb_cmd_wmask,

  input  o_icb_rsp_valid,
  output o_icb_rsp_ready,
  input  o_icb_rsp_err,
  input  [`E203_ITCM_DATA_WIDTH-1:0] o_icb_rsp_rdata 
