...
<!--ts-->
   * [1 概述](#1 概述)
   * [2 蜂鸟FPGA开发板](#2 蜂鸟FPGA开发板)
      * [2.1	 FPGA开发板总体说明](#2.1	 FPGA开发板总体说明)
      * [2.2	 FPGA开发板的购买途径](#2.2	 FPGA开发板的购买途径)
      * [2.3	 FPGA开发板的硬件指标](#2.3	 FPGA开发板的硬件指标)
      * [2.4	 FPGA开发板的电路原理图](#2.4	 FPGA开发板的电路原理图)
      * [2.5	 FPGA开发板的MCU部分](#2.5	 FPGA开发板的MCU部分)
      * [2.6	 FPGA开发板的常规功能部分](#2.6	 FPGA开发板的常规功能部分)      
      * [2.7	 烧写蜂鸟E203项目至FPGA开发板](#2.7	 烧写蜂鸟E203项目至FPGA开发板)      
      * [2.8	 使用FPGA开发板进行软件开发与调试](#2.8	 使用FPGA开发板进行软件开发与调试)
   * [3	 蜂鸟JTAG调试器](#3	 蜂鸟JTAG调试器)
      * [3.1	 JTAG调试器总体说明](#3.1	 JTAG调试器总体说明)
      * [3.2	 JTAG调试器的购买途径](#3.2	 JTAG调试器的购买途径)
      * [3.3	 JTAG调试器与FPGA开发板相连](#3.3	 JTAG调试器与FPGA开发板相连)
      * [3.4	 使用JTAG调试器进行软件下载与调试](#3.4	 使用JTAG调试器进行软件下载与调试)   
<!--te-->
